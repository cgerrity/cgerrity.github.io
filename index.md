...
| :--- | :--- |
| **Programming & Computation** | MATLAB (Expertise in neural data processing and modeling pipelines), Python (Actively expanding capabilities, including NumPy), R, LaTeX, Git, GPU Computing, SLURM |
