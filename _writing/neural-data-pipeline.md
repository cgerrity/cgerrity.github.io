...
<figure class="wide fig">
<svg class="diagram" viewBox="0 0 720 268" role="img" aria-labelledby="cmap-title">
  <title id="cmap-title">Channel-to-channel correlation before and after the channel-map fix: scrambled without a correct map, block-diagonal neighbor structure with it</title>
  <text class="t-title" x="145" y="40" text-anchor="middle">Unmapped (scrambled)</text>
  <rect x="70" y="52" width="15" height="15" fill="var(--color-accent)" opacity="1.0"/>
  <rect x="85" y="52" width="15" height="15" fill="var(--color-accent)" opacity="0.055"/>
  <rect x="100" y="52" width="15" height="15" fill="var(--color-accent)" opacity="0.395"/>
  <rect x="115" y="52" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="130" y="52" width="15" height="15" fill="var(--color-accent)" opacity="0.826"/>
  <rect x="145" y="52" width="15" height="15" fill="var(--color-accent)" opacity="0.192"/>
  <rect x="160" y="52" width="15" height="15" fill="var(--color-accent)" opacity="0.097"/>
  <rect x="175" y="52" width="15" height="15" fill="var(--color-accent)" opacity="0.826"/>
  <rect x="190" y="52" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="205" y="52" width="15" height="15" fill="var(--color-accent)" opacity="0.3"/>
  <rect x="70" y="67" width="15" height="15" fill="var(--color-accent)" opacity="0.055"/>
  <rect x="85" y="67" width="15" height="15" fill="var(--color-accent)" opacity="1.0"/>
  <rect x="100" y="67" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="115" y="67" width="15" height="15" fill="var(--color-accent)" opacity="0.395"/>
  <rect x="130" y="67" width="15" height="15" fill="var(--color-accent)" opacity="0.097"/>
  <rect x="145" y="67" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="160" y="67" width="15" height="15" fill="var(--color-accent)" opacity="0.826"/>
  <rect x="175" y="67" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="190" y="67" width="15" height="15" fill="var(--color-accent)" opacity="0.826"/>
  <rect x="205" y="67" width="15" height="15" fill="var(--color-accent)" opacity="0.395"/>
  <rect x="70" y="82" width="15" height="15" fill="var(--color-accent)" opacity="0.395"/>
  <rect x="85" y="82" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="100" y="82" width="15" height="15" fill="var(--color-accent)" opacity="1.0"/>
  <rect x="115" y="82" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="130" y="82" width="15" height="15" fill="var(--color-accent)" opacity="0.192"/>
  <rect x="145" y="82" width="15" height="15" fill="var(--color-accent)" opacity="0.826"/>
  <rect x="160" y="82" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="175" y="82" width="15" height="15" fill="var(--color-accent)" opacity="0.826"/>
  <rect x="190" y="82" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="205" y="82" width="15" height="15" fill="var(--color-accent)" opacity="0.055"/>
  <rect x="70" y="97" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="85" y="97" width="15" height="15" fill="var(--color-accent)" opacity="0.395"/>
  <rect x="100" y="97" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="115" y="97" width="15" height="15" fill="var(--color-accent)" opacity="1.0"/>
  <rect x="130" y="97" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="145" y="97" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="160" y="97" width="15" height="15" fill="var(--color-accent)" opacity="0.192"/>
  <rect x="175" y="97" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="190" y="97" width="15" height="15" fill="var(--color-accent)" opacity="0.826"/>
  <rect x="205" y="97" width="15" height="15" fill="var(--color-accent)" opacity="0.15"/>
  <rect x="70" y="112" width="15" height="15" fill="var(--color-accent)" opacity="0.826"/>
  <rect x="85" y="112" width="15" height="15" fill="var(--color-accent)" opacity="0.097"/>
  <rect x="100" y="112" width="15" height="15" fill="var(--color-accent)" opacity="0.192"/>
  <rect x="115" y="112" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="130" y="112" width="15" height="15" fill="var(--color-accent)" opacity="1.0"/>
  <rect x="145" y="112" width="15" height="15" fill="var(--color-accent)" opacity="0.15"/>
  <rect x="160" y="112" width="15" height="15" fill="var(--color-accent)" opacity="0.3"/>
  <rect x="175" y="112" width="15" height="15" fill="var(--color-accent)" opacity="0.395"/>
  <rect x="190" y="112" width="15" height="15" fill="var(--color-accent)" opacity="0.055"/>
  <rect x="205" y="112" width="15" height="15" fill="var(--color-accent)" opacity="0.731"/>
  <rect x="70" y="127" width="15" height="15" fill="var(--color-accent)" opacity="0.192"/>
  <rect x="85" y="127" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="100" y="127" width="15" height="15" fill="var(--color-accent)" opacity="0.826"/>
  <rect x="115" y="127" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="130" y="127" width="15" height="15" fill="var(--color-accent)" opacity="0.15"/>
  <rect x="145" y="127" width="15" height="15" fill="var(--color-accent)" opacity="1.0"/>
  <rect x="160" y="127" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="175" y="127" width="15" height="15" fill="var(--color-accent)" opacity="0.395"/>
  <rect x="190" y="127" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="205" y="127" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="70" y="142" width="15" height="15" fill="var(--color-accent)" opacity="0.097"/>
  <rect x="85" y="142" width="15" height="15" fill="var(--color-accent)" opacity="0.826"/>
  <rect x="100" y="142" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="115" y="142" width="15" height="15" fill="var(--color-accent)" opacity="0.192"/>
  <rect x="130" y="142" width="15" height="15" fill="var(--color-accent)" opacity="0.3"/>
  <rect x="145" y="142" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="160" y="142" width="15" height="15" fill="var(--color-accent)" opacity="1.0"/>
  <rect x="175" y="142" width="15" height="15" fill="var(--color-accent)" opacity="0.055"/>
  <rect x="190" y="142" width="15" height="15" fill="var(--color-accent)" opacity="0.395"/>
  <rect x="205" y="142" width="15" height="15" fill="var(--color-accent)" opacity="0.826"/>
  <rect x="70" y="157" width="15" height="15" fill="var(--color-accent)" opacity="0.826"/>
  <rect x="85" y="157" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="100" y="157" width="15" height="15" fill="var(--color-accent)" opacity="0.826"/>
  <rect x="115" y="157" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="130" y="157" width="15" height="15" fill="var(--color-accent)" opacity="0.395"/>
  <rect x="145" y="157" width="15" height="15" fill="var(--color-accent)" opacity="0.395"/>
  <rect x="160" y="157" width="15" height="15" fill="var(--color-accent)" opacity="0.055"/>
  <rect x="175" y="157" width="15" height="15" fill="var(--color-accent)" opacity="1.0"/>
  <rect x="190" y="157" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="205" y="157" width="15" height="15" fill="var(--color-accent)" opacity="0.097"/>
  <rect x="70" y="172" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="85" y="172" width="15" height="15" fill="var(--color-accent)" opacity="0.826"/>
  <rect x="100" y="172" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="115" y="172" width="15" height="15" fill="var(--color-accent)" opacity="0.826"/>
  <rect x="130" y="172" width="15" height="15" fill="var(--color-accent)" opacity="0.055"/>
  <rect x="145" y="172" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="160" y="172" width="15" height="15" fill="var(--color-accent)" opacity="0.395"/>
  <rect x="175" y="172" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="190" y="172" width="15" height="15" fill="var(--color-accent)" opacity="1.0"/>
  <rect x="205" y="172" width="15" height="15" fill="var(--color-accent)" opacity="0.192"/>
  <rect x="70" y="187" width="15" height="15" fill="var(--color-accent)" opacity="0.3"/>
  <rect x="85" y="187" width="15" height="15" fill="var(--color-accent)" opacity="0.395"/>
  <rect x="100" y="187" width="15" height="15" fill="var(--color-accent)" opacity="0.055"/>
  <rect x="115" y="187" width="15" height="15" fill="var(--color-accent)" opacity="0.15"/>
  <rect x="130" y="187" width="15" height="15" fill="var(--color-accent)" opacity="0.731"/>
  <rect x="145" y="187" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="160" y="187" width="15" height="15" fill="var(--color-accent)" opacity="0.826"/>
  <rect x="175" y="187" width="15" height="15" fill="var(--color-accent)" opacity="0.097"/>
  <rect x="190" y="187" width="15" height="15" fill="var(--color-accent)" opacity="0.192"/>
  <rect x="205" y="187" width="15" height="15" fill="var(--color-accent)" opacity="1.0"/>
  <rect x="70" y="52" width="150" height="150" fill="none" class="box" opacity="0.9"/>
  <text class="t-title" x="505" y="40" text-anchor="middle">Mapped (fixed)</text>
  <rect x="430" y="52" width="15" height="15" fill="var(--color-accent)" opacity="1.0"/>
  <rect x="445" y="52" width="15" height="15" fill="var(--color-accent)" opacity="0.826"/>
  <rect x="460" y="52" width="15" height="15" fill="var(--color-accent)" opacity="0.395"/>
  <rect x="475" y="52" width="15" height="15" fill="var(--color-accent)" opacity="0.192"/>
  <rect x="490" y="52" width="15" height="15" fill="var(--color-accent)" opacity="0.15"/>
  <rect x="505" y="52" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="520" y="52" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="535" y="52" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="550" y="52" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="565" y="52" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="430" y="67" width="15" height="15" fill="var(--color-accent)" opacity="0.826"/>
  <rect x="445" y="67" width="15" height="15" fill="var(--color-accent)" opacity="1.0"/>
  <rect x="460" y="67" width="15" height="15" fill="var(--color-accent)" opacity="0.826"/>
  <rect x="475" y="67" width="15" height="15" fill="var(--color-accent)" opacity="0.395"/>
  <rect x="490" y="67" width="15" height="15" fill="var(--color-accent)" opacity="0.192"/>
  <rect x="505" y="67" width="15" height="15" fill="var(--color-accent)" opacity="0.055"/>
  <rect x="520" y="67" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="535" y="67" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="550" y="67" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="565" y="67" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="430" y="82" width="15" height="15" fill="var(--color-accent)" opacity="0.395"/>
  <rect x="445" y="82" width="15" height="15" fill="var(--color-accent)" opacity="0.826"/>
  <rect x="460" y="82" width="15" height="15" fill="var(--color-accent)" opacity="1.0"/>
  <rect x="475" y="82" width="15" height="15" fill="var(--color-accent)" opacity="0.826"/>
  <rect x="490" y="82" width="15" height="15" fill="var(--color-accent)" opacity="0.395"/>
  <rect x="505" y="82" width="15" height="15" fill="var(--color-accent)" opacity="0.097"/>
  <rect x="520" y="82" width="15" height="15" fill="var(--color-accent)" opacity="0.055"/>
  <rect x="535" y="82" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="550" y="82" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="565" y="82" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="430" y="97" width="15" height="15" fill="var(--color-accent)" opacity="0.192"/>
  <rect x="445" y="97" width="15" height="15" fill="var(--color-accent)" opacity="0.395"/>
  <rect x="460" y="97" width="15" height="15" fill="var(--color-accent)" opacity="0.826"/>
  <rect x="475" y="97" width="15" height="15" fill="var(--color-accent)" opacity="1.0"/>
  <rect x="490" y="97" width="15" height="15" fill="var(--color-accent)" opacity="0.826"/>
  <rect x="505" y="97" width="15" height="15" fill="var(--color-accent)" opacity="0.3"/>
  <rect x="520" y="97" width="15" height="15" fill="var(--color-accent)" opacity="0.097"/>
  <rect x="535" y="97" width="15" height="15" fill="var(--color-accent)" opacity="0.055"/>
  <rect x="550" y="97" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="565" y="97" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="430" y="112" width="15" height="15" fill="var(--color-accent)" opacity="0.15"/>
  <rect x="445" y="112" width="15" height="15" fill="var(--color-accent)" opacity="0.192"/>
  <rect x="460" y="112" width="15" height="15" fill="var(--color-accent)" opacity="0.395"/>
  <rect x="475" y="112" width="15" height="15" fill="var(--color-accent)" opacity="0.826"/>
  <rect x="490" y="112" width="15" height="15" fill="var(--color-accent)" opacity="1.0"/>
  <rect x="505" y="112" width="15" height="15" fill="var(--color-accent)" opacity="0.731"/>
  <rect x="520" y="112" width="15" height="15" fill="var(--color-accent)" opacity="0.3"/>
  <rect x="535" y="112" width="15" height="15" fill="var(--color-accent)" opacity="0.097"/>
  <rect x="550" y="112" width="15" height="15" fill="var(--color-accent)" opacity="0.055"/>
  <rect x="565" y="112" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="430" y="127" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="445" y="127" width="15" height="15" fill="var(--color-accent)" opacity="0.055"/>
  <rect x="460" y="127" width="15" height="15" fill="var(--color-accent)" opacity="0.097"/>
  <rect x="475" y="127" width="15" height="15" fill="var(--color-accent)" opacity="0.3"/>
  <rect x="490" y="127" width="15" height="15" fill="var(--color-accent)" opacity="0.731"/>
  <rect x="505" y="127" width="15" height="15" fill="var(--color-accent)" opacity="1.0"/>
  <rect x="520" y="127" width="15" height="15" fill="var(--color-accent)" opacity="0.826"/>
  <rect x="535" y="127" width="15" height="15" fill="var(--color-accent)" opacity="0.395"/>
  <rect x="550" y="127" width="15" height="15" fill="var(--color-accent)" opacity="0.192"/>
  <rect x="565" y="127" width="15" height="15" fill="var(--color-accent)" opacity="0.15"/>
  <rect x="430" y="142" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="445" y="142" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="460" y="142" width="15" height="15" fill="var(--color-accent)" opacity="0.055"/>
  <rect x="475" y="142" width="15" height="15" fill="var(--color-accent)" opacity="0.097"/>
  <rect x="490" y="142" width="15" height="15" fill="var(--color-accent)" opacity="0.3"/>
  <rect x="505" y="142" width="15" height="15" fill="var(--color-accent)" opacity="0.826"/>
  <rect x="520" y="142" width="15" height="15" fill="var(--color-accent)" opacity="1.0"/>
  <rect x="535" y="142" width="15" height="15" fill="var(--color-accent)" opacity="0.826"/>
  <rect x="550" y="142" width="15" height="15" fill="var(--color-accent)" opacity="0.395"/>
  <rect x="565" y="142" width="15" height="15" fill="var(--color-accent)" opacity="0.192"/>
  <rect x="430" y="157" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="445" y="157" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="460" y="157" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="475" y="157" width="15" height="15" fill="var(--color-accent)" opacity="0.055"/>
  <rect x="490" y="157" width="15" height="15" fill="var(--color-accent)" opacity="0.097"/>
  <rect x="505" y="157" width="15" height="15" fill="var(--color-accent)" opacity="0.395"/>
  <rect x="520" y="157" width="15" height="15" fill="var(--color-accent)" opacity="0.826"/>
  <rect x="535" y="157" width="15" height="15" fill="var(--color-accent)" opacity="1.0"/>
  <rect x="550" y="157" width="15" height="15" fill="var(--color-accent)" opacity="0.826"/>
  <rect x="565" y="157" width="15" height="15" fill="var(--color-accent)" opacity="0.395"/>
  <rect x="430" y="172" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="445" y="172" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="460" y="172" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="475" y="172" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="490" y="172" width="15" height="15" fill="var(--color-accent)" opacity="0.055"/>
  <rect x="505" y="172" width="15" height="15" fill="var(--color-accent)" opacity="0.192"/>
  <rect x="520" y="172" width="15" height="15" fill="var(--color-accent)" opacity="0.395"/>
  <rect x="535" y="172" width="15" height="15" fill="var(--color-accent)" opacity="0.826"/>
  <rect x="550" y="172" width="15" height="15" fill="var(--color-accent)" opacity="1.0"/>
  <rect x="565" y="172" width="15" height="15" fill="var(--color-accent)" opacity="0.826"/>
  <rect x="430" y="187" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="445" y="187" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="460" y="187" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="475" y="187" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="490" y="187" width="15" height="15" fill="var(--color-accent)" opacity="0.05"/>
  <rect x="505" y="187" width="15" height="15" fill="var(--color-accent)" opacity="0.15"/>
  <rect x="520" y="187" width="15" height="15" fill="var(--color-accent)" opacity="0.192"/>
  <rect x="535" y="187" width="15" height="15" fill="var(--color-accent)" opacity="0.395"/>
  <rect x="550" y="187" width="15" height="15" fill="var(--color-accent)" opacity="0.826"/>
  <rect x="565" y="187" width="15" height="15" fill="var(--color-accent)" opacity="1.0"/>
  <rect x="430" y="52" width="150" height="150" fill="none" class="box" opacity="0.9"/>
  <text class="t-muted" x="145" y="224" text-anchor="middle">no neighbor structure</text>
  <text class="t-accent" x="505" y="224" text-anchor="middle">neighbors correlate (diagonal + blocks)</text>
</svg>
<figcaption><b>The channel-map fix, validated.</b> Correlation between every pair of recording channels. With the channel order scrambled by the inverted map (left) the correlations look like noise; with the map rebuilt from first principles (right) the expected structure reappears, where neighboring contacts and channels within an area correlate. Illustrative schematic of the check I used.</figcaption>
</figure>
